...
namespace OpenWeatherMap.Standard.Core.Test
{
    ...
    public class ZipCodeTests
    {
        ...
        public void TestByZipCode()
        {
            ...
            A.CallTo(() => fake.GetAsync("https://api.openweathermap.org/data/2.5/weather?zip=32927,US&units=Standard&appid=YOUR_API_KEY&lang=en", "https://openweathermap.org/img/wn/")).Returns(Task.FromResult(expected));
