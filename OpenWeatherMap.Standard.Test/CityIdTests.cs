...
namespace OpenWeatherMap.Standard.Test
{
    ...
    public class CityIdTests
    {
        ...
        public void TestCloudy()
        {
            ...
            A.CallTo(() => fake.GetAsync("https://api.openweathermap.org/data/2.5/weather?id=2172797&units=Standard&appid=YOUR_API_KEY&lang=en")).Returns(Task.FromResult(expected));
